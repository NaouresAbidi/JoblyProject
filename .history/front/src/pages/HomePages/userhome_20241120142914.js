...
const UserHome = () => {
    ...
    const scrollToNext = () => {
        setCurrentPage(prevPage => Math.min(prevPage + 1, Math.ceil(news.length / 3)));
    };
                ...
                <aside className="common-properties" id="right-card">
                    ...
                    {news.length > 0 ? (
                        <div className="news-list-container" id="news-list-container">
                            <button className="scroll-btn up" onClick={scrollToTop} style={{ display: currentPage > 1 ? 'block' : 'none' }}>
                            ...
                            <button className="scroll-btn down" onClick={scrollToNext} style={{ display: currentPage * 3 < news.length ? 'block' : 'none' }}>
