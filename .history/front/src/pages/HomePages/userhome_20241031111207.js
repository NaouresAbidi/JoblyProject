...
import { faBookmark, faCommentDots } from '@fontawesome/free-regular-svg-icons';
    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: '#0a66c2' }}>
        <div className="container">
          <a className="navbar-brand" href="#"><img src="images/linkedin-logo.png" style={{ width: '48px' }} alt="LinkedIn Logo" /></a>
