          ...
          <div className="profile-picture-wrapper">//+
            <div className="profile-picture">//+
              ...
              <div className="hover-overlay">
                <label htmlFor="profile-upload" className="upload-label">Upload</label>
                <input
                  id="profile-upload"
                  type="file"
                  accept="image/*"
                ...
                />
                <button className="view-button" onClick={() => setShowPreview(true)}>View</button>
              </div>
            </div>
          </div>
...
>>>>>>> Tabnine >>>>>>>// {"conversationId":"1606776f-6b2f-4d33-be90-d38e1ce4d3d1","source":"instruct"}
        <p>Loading profile...</p>
      )}
    </div>
  );
