  ...
  const uploadProfilePicture = async () => {
    ...
    try {
      ...
      setProfile((prevProfile) => ({
        ...prevProfile,
        profilePicture: "http://localhost:3000/uploads/"+data.updatedUser.profilePicture,
      }));
    } catch (error) {
  ...
  return (
    <div className="profile-page">
      ...
      {Object.keys(profile).length > 0 ? (
        <>
        <img src={profile.profilePictureZ} alt="Profile Picture" className="profile-picture" />
<p>{profile.pr</p>
